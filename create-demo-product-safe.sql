-- Create Demo Product for Landing Page "See it in Action" (Safe Version)
-- Run this in your Supabase SQL Editor
-- This version handles existing data and policies gracefully
...
-- Create a demo profile for the brand (only if it doesn't exist)
INSERT INTO public.profiles (id, brand_id, full_name, created_at, updated_at)
VALUES (
